...
\resizebox{1\textwidth}{!}{% <------ Don't forget this %
  \begin{tabular}{|l|c|c|c|c|}
    \hline
    \textbf{Característica} & \textbf{Apache Kafka} & \textbf{Apache Pulsar} & \textbf{Amazon Kinesis} & \textbf{Azure Event Hubs} \\
    \hline
    ...
    \hline
    Encript. reposo & Configurable & Sí & Sí (AWS KMS) & Sí \\
    \hline
    Encript. tránsito & Sí & Sí & Sí & Sí \\
    \hline
