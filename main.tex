...
\fancyfoot[R]{\thepage}  % Page number on right side of footer
...
\usepackage[
    pdftitle={Arquitecturas de Streaming para Analítica de Salud: Un estudio comparativo de los enfoques Kappa y Delta},
    pdfauthor={Emiliano Conti},
    pdfsubject={Proyecto Final del Master en Big Data},
    pdfkeywords={Arquitecturas de streaming, Kappa, Delta, Big Data, monitoreo remoto de pacientes, Apache Kafka, Apache Flink, Apache Paimon, procesamiento en tiempo real, lakehouse, NEWS2, IoT médico, sistemas distribuidos, analítica de salud, streaming de datos, arquitecturas de datos},
    pdfcreator={LaTeX},
    pdfproducer={pdfTeX},
    pdflang={es},
    pdfcreationdate={D:20250523000000+00'00'},
    colorlinks=false,
    hidelinks
]{hyperref}
...
% \endgroup
% \cleardoublepage
% \setcounter{page}{10}  % Adjust according to what you want
